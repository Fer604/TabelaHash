...
public class hashes {
    ...
    public static int hMul(int x) {
        ...
        return (int)z;//Retorna os 32 bits finais como um inteiro Java, não zera o bit de sinal aqui por causa do linear
    }
    ...
    public static int hMisto(int x) {
        ...
        return x;//hash rápido, mas menos robusto,, não zera o bit de sinal aqui por causa do linear
    }
